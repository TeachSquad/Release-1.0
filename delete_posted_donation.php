...
<?php
$query=mysqli_query($conn,"select * FROM post_donation where Ngo_name='$ngoId'") or die(mysqli_error($conn));
...
?>
    ...
    <td><a href="delete_posted_request.php?<?php echo "para1=".$row['id']."=para2=".$row['Ngo_name'];?>" class="btn btn-danger">Delete</a></td>                    
</tr>
