...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    ...
    <a class="nav-item nav-link" href="volunteer_pickup_completed_list.php">Pick Up Completed list</a>
...
while($row_donation= mysqli_fetch_array($query_donation)){
    ...
    $query=mysqli_query($conn,"select * from donation_quantity where donation_Id='$donatioId' and ngo_id='$ngo_ID' and flag='0'") or die(mysqli_error($conn));
...
?>
<tr>
    <form action="marked_as_picked.php" method="get">
    ...
    <td><input type="submit" value="Mark as Picked"class="btn btn-danger"></a></td>
    </form>
</tr>
