...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      ...
      <a class="nav-item nav-link" href="post_donation.php?<?php echo $ngoId ?>">Post donation</a>
      <a class="nav-item nav-link" href="delete_posted_donation.php?<?php echo $ngoId ?>">Delete post</a>
      <a class="nav-item nav-link" href="view_donations.php?<?php echo $ngoId ?>">View donations to be picked</a>
      <a class="nav-item nav-link" href="view_donation_picked.php?<?php echo $ngoId ?>">View donations picked</a>
      <a class="nav-item nav-link" href="reached_ngo.php?<?php echo $ngoId ?>">Item recieved</a>
